...
const ar = {
  ...
  noResultsDesc: "جرّب تغيير الفلتر أو الموقع.",
  results: "نتيجة",
  messages: "الرسائل",
  ...
  emptyFeedDesc: "كن أول من ينشر إعلان في هذه المنطقة.",
  postFirst: "أضف إعلان",
  viewProfile: "عرض الحساب",
  featuredStrip: "مميزة",
  featuredStripDesc: "إعلانات شعبية حولك",
  ...
  markAsSold: "علّم كمباع",
  soldTo: "تم البيع إلى",
  chooseBuyer: "اختر المشتري",
  noBuyersYet: "لا يوجد من راسل عن هذا الإعلان بعد.",
  onlyBuyerCanRate: "يمكن للمشتري فقط تقييم البائع.",
  setupProfile: "أكمل حسابك",
  setupProfileDesc: "هكذا سيراك الناس في كاسر",
  ...
  intentBuy: "أريد الشراء",
  intentSell: "أريد البيع",
  intentBoth: "أبيع وأشتري",
  rateBuyer: "تقييم المشتري",
  share: "مشاركة",
  ...
  agreedWaitingReceipt: "تم الاتفاق — بانتظار تأكيد المشتري للاستلام",
  adminName: "كاسر",
  confirmReceipt: "نعم، وصلني",
  rateNow: "تقييم",
  deleteAccount: "حذف الحساب",
  deleteAccountConfirm: "حذف حسابك وكل إعلاناتك نهائياً؟ لا يمكن التراجع.",
  ...
  deleteAllChatsConfirm: "حذف كل المحادثات؟ يختفي من جانبك فقط.",
  theSeller: "البائع",
