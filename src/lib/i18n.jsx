...
const ar = {
  appName: "كاسر",
  tagline: "ساوم واشترِ حوالك",
  markAsAvailable: "إتاحة مرّة ثانية",
  home: "الرئيسية",
  search: "بحث",
  sell: "بيع",
  chats: "المحادثات",
  ...
  noResultsDesc: "جرّب تغيّر الفلاتر أو الموقع.",
  results: "نتيجة",
  messages: "الرسائل",
  ...
  emptyFeedDesc: "كن أول من ينشر في هالمنطقة.",
  postFirst: "أضف إعلان",
  ...
  deleteAllChatsConfirm: "حذف كل المحادثات؟ يختفي من جهتك بس.",
  theSeller: "البائع",
  ...
  supportFullNamePlaceholder: "اكتب اسمك",
  supportPhone: "رقم الجوال",
  supportEmail: "البريد الإلكتروني",
  supportEmailHint: "سيصلك تأكيد على هذا البريد.",
  supportFormDesc: "أخبرنا وش نقدر نساعدك فيه وراح نرد عليك عبر البريد.",
