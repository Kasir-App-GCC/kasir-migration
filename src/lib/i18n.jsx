...
const ar = {
  ...
  noBuyersYet: "لا أحد راسل عن هذا الإعلان بعد.",
  onlyBuyerCanRate: "لا يمكن تقييم البائع إلا مشتري هذا المنتج.",
  ...
  adminName: "كاسر",
  confirmReceipt: "تم استلام المنتج",
  rateNow: "قيّم",
  ...
  deleteAllChatsConfirm: "حذف جميع المحادثات؟ يختفي من جانبك فقط.",
  theSeller: "البائع",
