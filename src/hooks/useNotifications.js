    ...
    (async () => {
      ...
      try {
        ...
        const systemNotifs = (ns || []).map((n) => {
          ...
          if (n.type === "rate") {
            return { id: n.id, type: "rate", text: n.text, name: n.item_title, image: n.item_image, itemId: n.item_id, roomId: n.chatroom_id, referenceId: n.reference_id, date: n.created_date, unread: !n.read };
          }
